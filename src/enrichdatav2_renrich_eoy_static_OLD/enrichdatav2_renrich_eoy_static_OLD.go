...
func main() {
	...
	enrichData(fileName, startDate, endDate, emailColumnIndex, columnCount, timeOfYearColumnIndex)
}
...
func enrichData(fileName string, startDate string, endDate string, emailColumnIndex int64, columnCount int, timeOfYearColumnIndex int) {
