...
func main() {
	if (len(os.Args) < 9) {
		...
		fmt.Println("CORRECT Usage: enrichdata {fileName} {startDateStr} {boyEndDateStampIndex1} {boyEndDateStampIndex2} {moyEndDateStampIndex1} {moyEndDateStampIndex2} {emailColumnIndex} {columnCountIndex}")
		fmt.Println("")
		...
		fmt.Println("{boyEndDateStampIndex1} - index of possible column 1 that contains BOY end date range")
		fmt.Println("{boyEndDateStampIndex2} - index of possible column 2 that contains BOY end date range")
		fmt.Println("{moyEndDateStampIndex1} - index of possible column 1 that contains MOY end date range")
		fmt.Println("{moyEndDateStampIndex2} - index of possible column 2 that contains MOY end date range")
	...
	boyEndDateTimeStampIndexStr1 := os.Args[3]
	boyEndDateTimeStampIndexStr2 := os.Args[4]
	moyEndDateTimeStampIndexStr1 := os.Args[5]
	moyEndDateTimeStampIndexStr2 := os.Args[6]
	emailColumnIndexStr := os.Args[7]
	...
	boyEndDateTimeStampIndex64_1, err := strconv.ParseInt(boyEndDateTimeStampIndexStr1, 10, 64)
	if err != nil {
		fmt.Print("Error 1.6: " + err.Error())
		os.Exit(1)
	}
	boyEndDateTimeStampIndex1:= int(boyEndDateTimeStampIndex64_1)

	boyEndDateTimeStampIndex64_2, err := strconv.ParseInt(boyEndDateTimeStampIndexStr2, 10, 64)
	if err != nil {
		fmt.Print("Error 1.6: " + err.Error())
		os.Exit(1)
	}
	boyEndDateTimeStampIndex2:= int(boyEndDateTimeStampIndex64_2)

	moyEndDateTimeStampIndex64_1, err := strconv.ParseInt(moyEndDateTimeStampIndexStr1, 10, 64)
	if err != nil {
		fmt.Print("Error 1.6: " + err.Error())
		os.Exit(1)
	}
	moyEndDateTimeStampIndex1:= int(moyEndDateTimeStampIndex64_1)

	moyEndDateTimeStampIndex64_2, err := strconv.ParseInt(moyEndDateTimeStampIndexStr2, 10, 64)
	if err != nil {
		fmt.Print("Error 1.6: " + err.Error())
		os.Exit(1)
	}
	moyEndDateTimeStampIndex2:= int(moyEndDateTimeStampIndex64_2)

	value := convertStrToDate(startDateStr)
	t, _ := time.Parse(layout, value)
	startDate:= strconv.FormatInt(t.Unix(), 10)

	enrichData(fileName, startDate, boyEndDateTimeStampIndex1, boyEndDateTimeStampIndex2, moyEndDateTimeStampIndex1,
		moyEndDateTimeStampIndex2, emailColumnIndex, columnCount)
}
...
func enrichData(fileName string, startDate string, boyEndDateTimeStampIndex1 int, boyEndDateTimeStampIndex2 int,
	moyEndDateTimeStampIndex1 int, moyEndDateTimeStampIndex2 int, emailColumnIndex int64, columnCount int) {
	...
	for i, line := range lines {
		...
		boyEndDate := line[boyEndDateTimeStampIndex1]
		if (boyEndDate == "-1") {
			boyEndDate = line[boyEndDateTimeStampIndex2]
		}

		moyEndDate := line[moyEndDateTimeStampIndex1]
		if (moyEndDate == "-1") {
			moyEndDate = line[moyEndDateTimeStampIndex2]
		}
		if i > 0 {
